...
void size_counters_trace(bool alloc, gfp_t flags, int order, size_t pfn, u32 pid);
...
static inline void size_counters_trace(bool alloc, gfp_t flags, int order, size_t pfn, u32 pid)
{
}
